...
This repository contains 3 main files:
 ...
 - `second_tidy.txt` - This is the final output from the `run_analysis.R` script.  It contains a cleansed version of the sample data.
 - `Codebook.md` - Contains the definitions of each of the columns in our generated `second_tidy.txt` file.
